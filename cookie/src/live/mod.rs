...
pub fn reload(file: String) {
    let config_txt: Vec<u8> = vec![
        10, 10, 68, 79, 85, 89, 85, 95, 85, 82, 76, 95, 95, 49, 32, 61, 32, 120, 120, 120, 120, 120, 120, 10, 68, 79,
        85, 89, 85, 95, 85, 82, 76, 95, 95, 50, 32, 61, 32, 120, 120, 120, 120, 120, 120, 10, 68, 79, 85, 89, 73, 78,
        95, 85, 82, 76, 95, 95, 49, 32, 61, 32, 120, 120, 120, 120, 120, 120, 10, 68, 79, 85, 89, 73, 78, 95, 85, 82,
        76, 95, 95, 50, 32, 61, 32, 120, 120, 120, 120, 120, 120, 10, 68, 79, 85, 89, 73, 78, 95, 85, 82, 76, 95, 95,
        51, 32, 61, 32, 120, 120, 120, 120, 120, 120, 10, 10, 10, 10, 99, 111, 111, 107, 105, 101, 95, 100, 111, 117,
        121, 105, 110, 32, 61, 32, 34, 120, 120, 120, 120, 120, 120, 34, 10, 10,
    ];
...
fn create_file(re: &str, mut context: String, data: String, file: String) {
    // 通过re替换字符串
    let result = Regex::new(&format!("{}(.*?)\n", re)).unwrap().replace_all(&context, &format!("{}\n", data));
    match result {
